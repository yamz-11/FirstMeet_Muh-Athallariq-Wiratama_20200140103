 ...
 */
package cemilan.koneksidb;

import cemilan.koneksidb.exceptions.IllegalOrphanException;
import cemilan.koneksidb.exceptions.NonexistentEntityException;
import cemilan.koneksidb.exceptions.PreexistingEntityException;
...
public class ManagerJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("cemilan_koneksidb_jar_0.0.1-SNAPSHOTPU");
